...
$query = $DBcon->query("SELECT * FROM urunler", PDO::FETCH_ASSOC);
$counter = 0;
    ...
    <div class="container-fluid pt-5">
        <div class="row pt-5 ms-5">
            <div class="col-md-2 col-12 sidebar">
                <p class="satis_gecis_p">Ana Sayfa</p>
                <p class="satis_gecis_gozat">Göz At:</p>
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a href="satis.php" class="aktif">Tüm Ürünler</a></li>
            ...
            <div class="col-md-10 col-12">
                <h1 class="product-title">Tüm Ürünler</h1>
