...
$query = $DBcon->query("SELECT * FROM urunler WHERE urun_kategori = 'Cilt Bakımı'", PDO::FETCH_ASSOC);
$counter = 0;
    ...
    <div class="container-fluid pt-5">
        <div class="row pt-5 ms-5">
            <div class="col-md-2 col-12 sidebar">
                ...
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a class="a" href="satis-CiltBakim_kategori.php?kategori=Günes">Güneş</a></li>
                    <li><a class="a" href="satis-CiltBakim_kategori.php?kategori=Yüz Bakım">Yüz Bakımı</a></li>
                    <li><a class="a" href="satis-CiltBakim_kategori.php?kategori=El ve Vücut">El ve Vücut</a></li>
                </ul>
                <div class="mb-5"></div>
            ...
            <div class="col-md-10 col-12">
                <h1 class="product-title">Cilt Bakımı</h1>
