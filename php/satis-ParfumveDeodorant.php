...
$query = $DBcon->query("SELECT * FROM urunler WHERE urun_kategori = 'Parfüm ve Deodorant'", PDO::FETCH_ASSOC);
$counter = 0;
...
<style>.sidebar {padding: 20px;border-right: 1px solid #000;height: 840px;}</style>
<body>
<!-- MENU BAŞLANGIÇ -->
    ...
    <div class="container-fluid pt-5">
        <div class="row pt-5 ms-5">
            <div class="col-md-2 col-12 sidebar">
                <p class="satis_gecis_p">Ana Sayfa <big>&nbsp;&gt;&nbsp;</big> Parfüm ve Deodorant</p>
                <p class="satis_gecis_gozat">Göz At:</p>
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a href="satis.php" >Tüm Ürünler</a></li>
                    <li><a href="satis-Makyaj.php">Makyaj</a></li>
                    ...
                    <li><a href="satis-ParfumveDeodorant.php" class="aktif">Parfüm ve Deodorant</a></li>
                </ul>
                <div class="mb-5"></div>
                ...
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a class="a" href="satis-ParfumveDeodorant_kategori.php?kategori=Kadın Parfümleri">Kadın Parfümleri</a></li>
                    <li><a class="a" href="satis-ParfumveDeodorant_kategori.php?kategori=Erkek Parfümleri">Erkek Parfümleri</a></li>
                    <li><a class="a" href="satis-ParfumveDeodorant_kategori.php?kategori=Parfüm Seti">Parfüm Seti</a></li>
                    <li><a class="a" href="satis-ParfumveDeodorant_kategori.php?kategori=Kadın Roll-On Deodorant">Kadın Roll-On Deodorant</a></li>
                    <li><a class="a" href="satis-ParfumveDeodorant_kategori.php?kategori=Erkek Roll-On Deodorant">Erkek Roll-On Deodorant</a></li>
                </ul>
                <div class="mb-5"></div>
            ...
            <div class="col-md-10 col-12">
                <h1 class="product-title">Parfüm ve Deodorant</h1>
