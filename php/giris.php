  ...
  <section class="py-3 py-md-5 py-xl-8">
    <div class="container pt-5">
      <div class="row">
        <div class="col-12">
          <div class="mb-5">
            <h2 class="display-5 fw-bold text-center">Giriş yap</h2>
            <p class="text-center m-0">Mevcut bir hesabınız yok mu? <a href="kayit_ol.php">Kayıt ol</a></p>
          </div>
        </div>
      </div>
              ...
              <form id="myForm" method="post">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12 mt-5">
                    <div class="d-grid">
                      <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Giriş Yap</button>
                    </div>
                  </div>
                </div>
              </form>
