...
$query = $DBcon->query("SELECT * FROM urunler WHERE urun_kategori = 'Kişisel Bakım'", PDO::FETCH_ASSOC);
$counter = 0;
    ...
    <div class="container-fluid pt-5">
        <div class="row pt-5 ms-5">
            <div class="col-md-2 col-12 sidebar">
                <p class="satis_gecis_p">Ana Sayfa <big>&nbsp;&gt;&nbsp;</big> Kişisel Bakım</p>
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="satis-KisiselBakim.php" class="aktif">Kişisel Bakım</a></li>
                ...
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a class="a" href="satis-KisiselBakim_kategori.php?kategori=Ayak ve Tırnak Bakımı">Ayak ve Tırnak Bakımı</a></li>
                    <li><a class="a" href="satis-KisiselBakim_kategori.php?kategori=Epilasyon Agda ve Tıras">Epilasyon Ağda ve Tıraş</a></li>
                    <li><a class="a" href="satis-KisiselBakim_kategori.php?kategori=Agız ve Dis Bakım">Ağız ve Diş Bakım</a></li>
                    <li><a class="a" href="satis-KisiselBakim_kategori.php?kategori=Dus ve Banyo">Duş ve Banyo</a></li>
                </ul>
                <div class="mb-5"></div>
            ...
            <div class="col-md-10 col-12">
                <h1 class="product-title">Kisisel Bakım</h1>
