...
$query = $DBcon->query("SELECT * FROM urunler WHERE urun_kategori = 'Saç Bakımı'", PDO::FETCH_ASSOC);
$counter = 0;
    ...
    <div class="container-fluid pt-5">
        <div class="row pt-5 ms-5">
            <div class="col-md-2 col-12 sidebar">
                <p class="satis_gecis_p">Ana Sayfa <big>&nbsp;&gt;&nbsp;</big> Saç Bakımı</p>
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="satis-SacBakim.php" class="aktif">Saç Bakımı</a></li>
                ...
                <div class="divider"></div>
                <ul class="list-unstyled">
                    <li><a class="a" href="satis-SacBakim_kategori.php?kategori=Saç Boyaları">Saç Boyaları</a></li>
                    <li><a class="a" href="satis-SacBakim_kategori.php?kategori=Saç Bakım Ürünleri">Saç Bakım Ürünleri</a></li>
                    <li><a class="a" href="satis-SacBakim_kategori.php?kategori=Saç Aksesuarları">Saç Aksesuarları</a></li>
                </ul>
                <div class="mb-5"></div>
            ...
            <div class="col-md-10 col-12">
                <h1 class="product-title">Saç Bakımı</h1>
